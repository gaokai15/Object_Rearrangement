...
class Experiment(object):
    def __init__(
        ...
        self.polygon = np.array(poly_disk([0, 0], self.RAD, 90))  ### object shape
        self.wall_pts = pn.Polygon(
            ...
            [
                ...
                (self.WIDTH / 2, self.HEIGHT / 3 + 2),
                (self.WIDTH, self.HEIGHT / 3 + 2),
                (self.WIDTH, self.HEIGHT * 2 / 3 - 2),
                (self.WIDTH / 2, self.HEIGHT * 2 / 3 - 2),
                (self.WIDTH / 2, self.HEIGHT * 2 / 3 + 2),
                (self.WIDTH, self.HEIGHT * 2 / 3 + 2),
            ...
            #     (self.WIDTH - self.RAD, self.HEIGHT / 3 - 2 - self.RAD),
            #     (self.WIDTH / 2, self.HEIGHT / 3 - 2 - self.RAD),
            #     (self.WIDTH / 2 - self.RAD, self.HEIGHT / 3 - 2),
            #     (self.WIDTH / 2 - self.RAD, self.HEIGHT / 3 + 2),
            #     (self.WIDTH / 2, self.HEIGHT / 3 + 2 + self.RAD),
            #     (self.WIDTH - self.RAD, self.HEIGHT / 3 + 2 + self.RAD),
            #     (self.WIDTH - self.RAD, self.HEIGHT * 2 / 3 - 2 - self.RAD),
            #     (self.WIDTH / 2, self.HEIGHT * 2 / 3 - 2 - self.RAD),
            #     (self.WIDTH / 2 - self.RAD, self.HEIGHT * 2 / 3 - 2),
            #     (self.WIDTH / 2 - self.RAD, self.HEIGHT * 2 / 3 + 2),
            #     (self.WIDTH / 2, self.HEIGHT * 2 / 3 + 2 + self.RAD),
            #     (self.WIDTH - self.RAD, self.HEIGHT * 2 / 3 + 2 + self.RAD),
        ...
        self.wall_mink = pn.Polygon(
            # [
            #     (self.RAD, self.RAD), (self.WIDTH - self.RAD, self.RAD),
        ...
        self.instance = InstanceGenerator(self.numObjs, self.wall_mink, self.polygon)  ### an InstanceGenerator object
        ...
        self.visualTool = Visualizer(
            self.HEIGHT, self.WIDTH, self.numObjs, self.wall_pts, self.display, self.displayMore, self.saveimage,
            self.data_path
        )
        self.instance.genBuffers(self.wall_mink, self.numObjs)
