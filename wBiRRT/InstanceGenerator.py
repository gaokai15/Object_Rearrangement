...
class InstanceGenerator(object):
    def __init__(self, numObjs, wall_mink, polygon):
        if numObjs == 0:
            self.polygon = None
            self.points = None
            self.objects = None
        ...
        self.points, self.objects, self.minkowski_objs = self.generateInstance(numObjs, wall_mink)
    ...
    def copy(self):
        new_instance = InstanceGenerator(0, None, 0)
    ...
    def generateInstance(self, numObjs, wall_mink):
        ### this function tries to generate a instance with the allowed amount of trials
        points, objects, minkowski_objs = self.genSingleInstance(numObjs, wall_mink)
    ...
    def genSingleInstance(self, numObjs, wall_mink):
    ...
    def genBuffers(self, wall_mink, numObjs):
