...
class RegionGraphGenerator(object):
    def __init__(self, instance, wall_mink):
        self.epsilon = 2**-8
        self.wall_mink = wall_mink
        self.regions, self.obj2reg = self.genRegionGraph(instance)
        self.paths = self.connectRegionGraph(instance)
    ...
    def connectRegionGraph(self, instance):
