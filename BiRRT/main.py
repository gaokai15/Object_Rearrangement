...
if __name__ == "__main__":
    ...
    for para_comb in para_combinations:
        ...
        f_stat.write(str(numActions_biRRT / successSolTimes_biRRT) + " " + str(numActions_biRRTstar / successSolTimes_biRRTstar) + " " + str(numActions_DP_local / successSolTimes_DP_local) + " " + \
                str(comTime_biRRT / successSolTimes_biRRT) + " " + str(comTime_biRRTstar / successSolTimes_biRRTstar) + " " + str(comTime_DP_local / successSolTimes_DP_local) + "\n")
