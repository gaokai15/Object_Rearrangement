...
alg1Style['label'] = r'\textsc{Leaf-Root}'    # Setup algorithm name. 
...
alg2Style['label'] = r'\textsc{Leaf-Small-Range(3)}'
alg2Style['color'] = 'tab:green'

# Another algorithm
alg3Style = deepcopy(defaultStyle)
alg3Style['label'] = r'\textsc{Leaf-Large-Range(num/3)}'
alg3Style['color'] = 'c'
...
ax.bar([x - 0.5*bar_width for x in range(10)], [Time[i][1] for i in range(len(Time))], bar_width, edgecolor = 'black', **alg2Style)
ax.bar([x + 0.5*bar_width for x in range(10)], [Time[i][2] for i in range(len(Time))], bar_width, edgecolor = 'black', **alg3Style)
ax.bar([x + 1.5*bar_width for x in range(10)], [Time[i][3] for i in range(len(Time))], bar_width, edgecolor = 'black', **alg4Style)
# ax.bar([x - 1.5*bar_width for x in range(10)], [Actions[i][0] for i in range(len(Time))], bar_width, edgecolor = 'black', **alg1Style)
# ax.bar([x - 0.5*bar_width for x in range(10)], [Actions[i][1] for i in range(len(Time))], bar_width, edgecolor = 'black', **alg2Style)
# ax.bar([x + 0.5*bar_width for x in range(10)], [Actions[i][2] for i in range(len(Time))], bar_width, edgecolor = 'black', **alg3Style)
