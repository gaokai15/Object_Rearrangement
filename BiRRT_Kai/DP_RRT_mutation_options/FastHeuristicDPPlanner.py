...
from DPLocalSolverNew import DFS_Rec_for_Monotone_General, DFS_Rec_for_Non_Monotone_General
from util import *
import os
import copy
import IPython
...
class FastHeuristicDPPlanner(object):
    ...
    def __init__(self, init_arr, final_arr, instance, gpd, new_paths, polygon, visualTool):
        ...
        self.k = min(3, int(self.numObjs/2)) 
        ...
        enablePrint()
        print "monotone time", time.time()-test_start
        blockPrint()
