DiskCSpace(
    ...
    poseMap={
        'S0': Circle(x=250, y=100, radius=50),
        'S1': Circle(x=250, y=300, radius=50),
        'S2': Circle(x=250, y=500, radius=50),
        'S3': Circle(x=250, y=800, radius=50),
        'S4': Circle(x=750, y=100, radius=50),
        'S5': Circle(x=750, y=300, radius=50),
        'S6': Circle(x=750, y=500, radius=50),
