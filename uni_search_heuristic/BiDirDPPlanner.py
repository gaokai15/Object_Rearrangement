...
class BiDirDPPlanner(object):
    ...
    ### Output:
    ### the whole plan 
    def __init__(self, init_arr, final_arr, instance, gpd, new_paths, polygon, visualTool):
    ...
    def visualizeLocalBranch(self, child_id, parent_id, connectMode):
        ...
        if connectMode == "L,L":
            ...
            self.visualTool.drawLocalMotions((parent_id, child_id), temp_ppath,
                self.points, self.poses, parentNode.arrangement, self.final_arrangement, "save-in-tree")
            ...
            self.visualTool.drawLocalMotions((child_id, parent_id), temp_ppath,
                self.points, self.poses, childNode.arrangement, self.final_arrangement, "save-in-tree")
            ...
            self.visualTool.drawLocalMotions((child_id, parent_id), temp_ppath,
                self.points, self.poses, leftNode.arrangement, self.final_arrangement, "save-in-tree")
