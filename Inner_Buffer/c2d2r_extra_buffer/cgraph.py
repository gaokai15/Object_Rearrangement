        ...
        for wpt_idx in range(len(rpaths[(key0, key1)]) - 1):
            ...
            for step in range(n_steps + 1):
                ...
                for nn in range(len(current_pts)):
                    ...
                    ax.add_patch(patch)
                    ax.text(current_pts[nn][0], current_pts[nn][1], "Obj"+str(nn), fontweight='bold', fontsize=10, zorder=3)
                    ### goal
                    if not isGoalReached[nn]:
                        ...
                        ax.add_patch(patch)
                        ax.text(goal_pts[nn][0], goal_pts[nn][1], "G"+str(nn), fontweight='bold', fontsize=10, zorder=1)
